...
public class PoliticaController {
    ...
    @GetMapping
    public ResponseEntity<List<PoliticaResponse>> findAll() {
        return ResponseEntity.ok(service.findAll());
    }

    @GetMapping("/{identifier}")
    public ResponseEntity<PoliticaResponse> findByIdentifier(@PathVariable String identifier) {
        try {
    ...
    @PostMapping
    public ResponseEntity<PoliticaResponse> create(@Valid @RequestBody PoliticaRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.create(request));
    }

    @PutMapping("/{id}")
    public ResponseEntity<PoliticaResponse> update(
            @PathVariable UUID id, @Valid @RequestBody PoliticaRequest request) {
